...
// -=-=-=-=-=-=-=-=-=
// NOTE(steve): you can uncomment the following line to test a different
// language instead of changing the device settings.
//
// I18n.locale = 'ja'
// -=-=-=-=-=-=-=-=-=

// set the language code from the device
